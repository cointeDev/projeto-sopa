...
export function Home() {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[35%_65%] bg-[#0F111A] font-inter">
      ...
      <section className="relative z-10 flex flex-col bg-[#161825] px-6 py-12 lg:px-10 shadow-[10px_0_30px_rgba(0,0,0,0.2)]">
        ...
        <div className="flex flex-1 flex-col justify-center gap-8 mt-8">
          ...
          {/* TEXTO */}
          <div>
            <h1 className="text-transparent bg-clip-text bg-linear-to-br from-white to-indigo-300 
            ...
            <p className="text-[#B4B9C7] text-lg leading-relaxed max-w-[90%]">
              Centralize solicitações, gerencie pautas de estúdio e acompanhe o fluxo de
              produção de mídia da COINTE em um só lugar.
            </p>
          </div>
