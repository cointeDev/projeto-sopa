                        ...
                        <input
                            ...
                            onChange={(event) => {
                                if (event.target.files?.[0])
                                    updateField("thumbnail", event.target.files[0]);
                            }}
                        />
                    </label>
                </div>
                ...
                <div className="md:col-span-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option className="bg-zinc-900" value="interna"> Veiculação Interna </option>
                            <option className="bg-zinc-900" value="seec"> Canal da SEEC </option>
                            <option className="bg-zinc-900" value="instagram"> Instagram da SEEC </option>
                            <option className="bg-zinc-900" value="outro"> Outro </option>
                        </select>
