...
const initialEvents = [
	// Exemplos de tarefas, usaremos as do banco de dados depois
	{
		id: "1",
		title: "Se liga no ENEM | Química - Aula 02",
		start: "2026-01-05T09:00:00",
		end: "2026-01-05T12:30:00",
		fase: "1",
		description: "Edição Final",
		url: "https://www.google.com/",
	},
	{
		id: "2",
		title: "Se liga no ENEM | História - Aula 03",
		start: "2026-01-06T15:00:00",
		end: "2026-01-06T16:30:00",
		fase: "2",
	...
	{
		id: "3",
		title: "Se liga no ENEM | Matemática - Aula 05",
		start: "2026-01-07T17:00:00",
		end: "2026-01-07T19:00:00",
		fase: "4",
		description: "Revisão LP+LSE",
		url: "https://www.google.com/",
	},
	{
		id: "4",
		title: "Se liga no ENEM | Física - Aula 02",
		start: "2026-01-08T12:00:00",
	...
	{
		id: "5",
		title: "Se liga no ENEM | Biologia - Aula 03",
		start: "2026-01-09T10:00:00",
		end: "2026-01-09T16:35:00",
		fase: "3",
		description: "Ajustes e Entrega",
		url: "https://www.google.com/",
	},
];
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6 overflow-y-auto p-4 rounded-lg bg-white shadow-lg">
					{filteredEvents.length > 0 ? (
						filteredEvents.map((event) => (
							<div
								key={event.id}
								className="bg-white border border-gray-200 shadow-md rounded-lg p-6 hover:shadow-xl transition-all flex flex-col h-auto cursor-pointer hover:scale-105 duration-200"
						...
						<p className="text-gray-500 text-lg col-span-2 text-center">
							Nenhuma demanda para esta data.
						</p>
					)}
				</div>
			</div>
